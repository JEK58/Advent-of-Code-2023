...
instructions.forEach(([_, __, enc]) => {
  const dist = parseInt(enc.substring(2, 7), 16);
  const dir = ["R", "D", "L", "U"][+enc.substring(7, 8)];
...
console.log("🚀 ~ part 2:", count + boundaryPoints); // 52240187443190
